    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
          <!-- logo start -->
          <div class="logo"> <img src="img/logo.png" alt="logo" width:50px> </div> 
		  <a href='menu/cart.php'><button class="button" style='margin-left: 50px;'>Back to Cart</button></a>
          <!-- logo end -->
        </div>
        <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="menu_side">
			...
			<?php
				...
				?>
			    <a href="../menu/cart.php"><img src="img/cart.png" style="width:50px;">Cart<span><?php echo $cart_count; ?></span></a>
			   <?php
				}
				?>
            ...
            <div class="panel panel-default credit-card-box">
              <div class="panel-heading display-table">
                <div class="display-tr">
                  ...
                  <div class="display-td"> <img class="img-responsive pull-right" src="img/accepted.jpg" style="width:300px;height:100px"> </div>
                </div>
              </div>
              <div class="panel-body">
                  ...
                  <div class="row">
					...
					<a href='paymentdone.php'><button class= 'button' type="submit" name="submit" class="btn_main btn-success btn-sm">Pay Now</button></a>
                      </div>
                    </div>
                  </div>
				  </div>
