    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
          <!-- logo start -->
          <div class="logo"> <a href="index.php"><img src="../img/logo.png" alt="logo" style="height:90px;"/></a> </div>
          <!-- logo end -->
        </div>
          ...
          <table class="table">
			...
			<?php		
              ...
              <tr>
				...
				<td><a href='delete.php?id=<?php echo $result_cart["cart_ID"]?>' ><input type="submit" class="button" id="<?php echo $result_cart["cart_ID"]; ?>" value='Remove'></a></td>
        ...
        <div class="shopping-cart-cart">
          <table>
            <tbody>
			  ...
			  ?>
			  <tr>
                <td><a href="../menu/index.php"><button type="button" class="button" >Continue Shopping</button><a></td>
			  </tr>
			  <?php
			  }
			  else
