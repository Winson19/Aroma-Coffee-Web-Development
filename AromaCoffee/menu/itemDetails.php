                    ...
                    while($row=mysqli_fetch_assoc($cakeResult))
                    {
                        echo "
                            <form method='POST'>
                                ...
                                <br>
                                Quantity: 
                                <input type='number' id='quantity' name='quantity' min='1' max='10'value='1' onclick='calculateTotalPrice(this)'>
                                <br>
                                Total Price: 
                                ...
                                <br>
                                <input class='button' type='submit' id='addCart' name='addCart' value='Add to cart'>
